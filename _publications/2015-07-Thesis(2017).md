...
excerpt: 'I design an analysis tool for the electrocardiographic QRS complex in arrhythmia patients. The tool implements classic algorithms(e.g., Pan-Tompkins, HC-Chen, So&Chen) and my innovative algorithms to compare the accuracy(confusion matrix) of arrhythmia detecting and performance comparison benchmark MIT- BIH arrhythmia database. 
<br><p align="center"><img src="/res/NTUMC/ECG/thesis.png" width="800" height="600"></p>'
date: 2017-07-05
