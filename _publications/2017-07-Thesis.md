...
excerpt: 'I design an analysis tool for electrocardiographic QRS complex occurring in arrhythmia patient. The tool implement some classic algorithms(e.g. Pan-Tompkins, HC-Chen, So&Chen) and my innovative algorithms to compare accuracy(confusion matrix) of arrhythmia detecting, and performance comparison on the benchmark MIT- BIH arrhythmia database.'
date: 2017-07-05
