...
excerpt: 'The present invention provides a pulse detection module and a use-as-you-need blood pressure measurement device comprising the pulse detection module. The pulse detection module is characterized by comprising a plurality of sensors and a controller linked to the sensors, wherein the sensors are arranged horizontally on the wrist watch in a direction parallel to a user\x27s limb on which the wrist watch is worn, and the controller obtains the user\x27s pulse signals through the sensors.'
date: 2016-12-01
venue: 'USPTO'
